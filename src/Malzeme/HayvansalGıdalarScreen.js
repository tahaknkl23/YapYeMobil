...
const HayvansalGıdalarScreen = ({navigation}) =>{
  ...
  const fruits = ['Yumurta', 'Et', 'Sucuk', 'Salam', 'Sosis','Kıyma', 'Kanat', 'Piliç', 'But', 'Tavuk Göğsü','Bonfile',
  'Piliç İncik', 'Kuşbaşi', 'Jambon', 'Nugget','Schnitzel', 'Antrikot', 'Dana Eti', 'Kuzu Eti', 'Dana Bonfiile','Kaburga', 'Dana Sote', 'Kuzu Sote', 'Döş',
    'İncik','Biftek', 'Ciğer ', 'Kelle', 'Pirzola', 'Hindi Füme','Hindi But', 'Füme Et', 'Pastırma', 'Mcar Salam', 'Pilinç Füme',];
...
<ScrollView style={styles.checkboxContainer}>
    <Image
        ...
        style={styles.image}
      />
          <Text style={styles.sebzelerText}>Hayvansal Gıdalar</Text>
...
export default HayvansalGıdalarScreen;