...
const KuruyemisScreen = ({navigation}) =>{
  ...
  const fruits = ['Fındık', 'Yer Fıstığı', 'Ceviz', 'Badem', 'Kaju','Antep Fıstığı', 'Çam Fıstığı', 'Kuş Üzüm', 'Kuru kayısı ', 'Kuş Üzümü','Kuru Erik',
  'Leblebi', 'Kabak Çekirdeği', 'Çekirdek', 'Lokum','Petibör', ];
...
<ScrollView style={styles.checkboxContainer}>
    <Image
        ...
        style={styles.image}
      />
          <Text style={styles.sebzelerText}>Kuruyemiş</Text>
...
export default KuruyemisScreen;